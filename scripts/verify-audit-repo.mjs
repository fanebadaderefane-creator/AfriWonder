...
ok = mustExist('frontend/.env.example') && ok;
...
ok = mustExist('frontend/app/_layout.tsx') && ok;
ok = mustExist('frontend/app.json') && ok;
ok = mustExist('frontend/metro.config.js', 'config Metro (Expo)') && ok;
ok = mustExist('doppler.yaml') && ok;

ok = requireContains('frontend/package.json', '"expo"', 'frontend/package.json → expo') && ok;
ok = requireContains('frontend/package.json', 'expo-router', 'frontend/package.json → expo-router') && ok;
