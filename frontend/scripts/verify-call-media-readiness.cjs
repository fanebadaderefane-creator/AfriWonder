...
const checks = [
  ...
  ['TURN TLS natif (prepareIceServersForPlatform)', /prepareIceServersForPlatform/],
  ['NetInfo snapshot unknown (pas faux cellulaire)', /resolveIceNetworkSnapshot/],
  ['Garde TURN TLS cellulaire natif', /shouldBlockNativeCellularWithoutTlsTurn/],
  ['Retry turn-credentials (cold start Render)', /loadTurnCredentials/],
  ...
  ['Maroc↔Mali — relay SDP distinct de policy', /shouldRequireRelayInOutboundSdp/],
  ['Maroc↔Mali — pas de SDP sans relay (answer/offer)', /shouldBlockOutboundSdpWithoutRequiredRelay/],
  ...
  ['Expéditeur audio actif (peerConnectionHasActiveAudioSender)', /peerConnectionHasActiveAudioSender/],
