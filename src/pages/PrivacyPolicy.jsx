...
export default function PrivacyPolicy() {
  ...
  if (!document) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50/30 flex items-center justify-center p-4">
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-blue-50/30 pb-20">
      <div className="sticky top-0 z-40 bg-white/95 backdrop-blur border-b-2 border-blue-500/20 shadow-sm">
        <div className="flex items-center gap-4 px-4 py-3">
          <Button variant="ghost" size="icon" onClick={() => navigate(-1)} className="text-blue-600 hover:text-blue-700 hover:bg-blue-50">
            <ArrowLeft className="w-6 h-6" />
          </Button>
          <h1 className="text-lg font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent flex-1">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-blue-600">{document.version}</span>
                {document.is_active && (
        ...
        {/* History Modal */}
        {showHistory && (
          <div className="bg-white rounded-xl shadow-lg border border-blue-100 p-6 mb-4">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Historique des versions</h3>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-blue-100 p-6 space-y-6">
          ...
          <div className="border-t pt-6">
            ...
            <div className="flex items-center gap-2 text-gray-700">
              ...
              <a href="mailto:fanebadaderefane@gmail.com" className="text-blue-600 font-medium hover:text-blue-700 hover:underline">
          ...
          <div className="mt-6 bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-bold mb-2 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Acceptation requise</h3>
