  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className="sticky top-0 bg-white border-b border-gray-100 z-40 px-4 py-3 flex items-center gap-3">
        <button
          onClick={() => navigate(-1)}
          className="p-1 -m-1 rounded-lg hover:bg-blue-50 text-gray-700 hover:text-blue-600 transition-colors"
        >
        ...
        {currentStep === 1 && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            ...
            <div>
              ...
              <label className="w-full min-h-[140px] p-6 border-2 border-dashed border-blue-300 rounded-xl cursor-pointer bg-blue-50/50 hover:bg-blue-50 hover:border-blue-400 transition-all flex flex-col items-center justify-center gap-2">
                <div className="w-14 h-14 rounded-full bg-blue-100 flex items-center justify-center">
                  <ImageIcon className="w-7 h-7 text-blue-600" />
                </div>
                <span className="text-sm font-medium text-blue-800">Cliquez ou glissez une image ici</span>
                <span className="text-xs text-blue-600">PNG, JPG — max. 5 Mo</span>
                <input type="file" accept={FILE_ACCEPT_IMAGES} onChange={handleImageUpload} className="hidden" />
              </label>
              {eventData.image_url && (
                <div className="mt-3 relative">
                  <img src={eventData.image_url} alt="Aperçu" className="w-full h-36 object-cover rounded-xl border border-blue-200" />
      ...
      <div className="fixed bottom-20 left-0 right-0 bg-white border-t border-gray-100 p-4">
        <div className="flex gap-2">
          ...
          {currentStep < 4 && (
            <Button
              onClick={() => setCurrentStep(currentStep + 1)}
              className="flex-1 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-medium shadow-sm"
            >
              Suivant
            </Button>
          )}
